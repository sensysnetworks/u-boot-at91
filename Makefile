...
CROSS_COMPILE=/opt/arm/bin/arm-none-linux-gnueabi-
...
som-9g20_nandflash_config \
som-9g20_dataflash_cs1_config \
som-9g20_config	:	unconfig
	@if [ "$(findstring _nandflash,$@)" ] ; then \
		echo "#define CONFIG_SYS_USE_NANDFLASH 1"	>>$(obj)include/config.h ; \
		$(XECHO) "... with environment variable in NAND FLASH" ; \
	else \
	...
	@$(MKCONFIG) -a som-9g20 arm arm926ejs som-9g20 atmel at91

som-9260_norflash_config \
som-9260_seeprom_cs1_config \
som-9260_config	:	unconfig
	@if [ "$(findstring _norflash,$@)" ] ; then \
		echo "#define CONFIG_SYS_USE_NORFLASH 1"	>>$(obj)include/config.h ; \
		$(XECHO) "... with environment variable in NOR FLASH" ; \
	else \
		echo "#define CONFIG_SYS_USE_SEEPROM_CS1 1"	>>$(obj)include/config.h ; \
		$(XECHO) "... with environment variable in SPI Serial EPROM CS1" ; \
	fi;	
	@$(MKCONFIG) -a som-9260 arm arm926ejs som-9260 atmel at91
