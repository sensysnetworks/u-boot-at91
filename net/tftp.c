...
ulong TftpTimeoutMSecsEnv = TIMEOUT;
int TftpTimeoutCountMaxEnv = TIMEOUT_COUNT;
...
TftpHandler (uchar * pkt, unsigned dest, unsigned src, unsigned len)
{
	...
	case TFTP_DATA:
		...
		TftpTimeoutMSecs = TftpTimeoutMSecsEnv;
		TftpTimeoutCountMax = TftpTimeoutCountMaxEnv;
...
TftpStart (void)
{
	...
	TftpTimeoutMSecs = getenv ("TIMEOUT") ? simple_strtoul(getenv ("TIMEOUT"), NULL, 10) * 1000 : TftpRRQTimeoutMSecs;
	TftpTimeoutCountMax = getenv ("RETRY") ? simple_strtoul(getenv ("RETRY"), NULL, 10) : TftpRRQTimeoutCountMax;
	...
	TftpTimeoutMSecsEnv = getenv ("TIMEOUT") ? simple_strtoul(getenv ("TIMEOUT"), NULL, 10) * 1000 : TIMEOUT;
	TftpTimeoutCountMaxEnv = getenv ("RETRY") ? simple_strtoul(getenv ("RETRY"), NULL, 10) : TIMEOUT_COUNT;
